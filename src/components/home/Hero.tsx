...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      ...
      style={{
        backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('https://images.pexels.com/photos/193021/pexels-photo-193021.jpeg?auto=compress&cs=tinysrgb&w=1920')",
    ...
    >
      <div className="container relative z-10">
        <div className="max-w-3xl">
          ...
          >
            Vistoria Veicular Profissional em <span className="text-primary">Piracicaba</span>
          </h1>
          ...
          >
            Garantimos segurança e tranquilidade na compra, venda ou transferência do seu veículo com laudos técnicos detalhados e confiáveis.
          </p>
          ...
          >
            ...
            <a href="#servicos" className="btn bg-white text-gray-900 hover:bg-gray-100">
              Nossos Serviços
            </a>
          </div>
